...
from .models.unet_plus_plus import UnetPlusPlusModel as _UnetPlusPlusModel
...
UnetPlusPlusModel = inject_global_submodules(_UnetPlusPlusModel)
...
__all__ = [
    'Unet', 'PSPNet', 'FPN', 'Linknet','UnetPlusPlusModel',
